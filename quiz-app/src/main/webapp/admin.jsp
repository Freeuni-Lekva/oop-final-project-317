...
<div class="flex h-screen">
    ...
    <div class="w-80 bg-white border-r border-gray-200 p-6 flex flex-col">
        ...
        <nav class="space-y-1 flex-1">
            <div class="sidebar-item p-3 rounded-lg cursor-pointer flex items-center space-x-3 bg-blue-50">
            ...
            <div class="sidebar-item p-3 rounded-lg cursor-pointer flex items-center space-x-3">
                ...
                <span class="text-slate-700 font-medium">Manage Quizzes</span>
            </div>
            ...
            <div class="sidebar-item p-3 rounded-lg cursor-pointer flex items-center space-x-3">
                ...
                <span class="text-slate-700 font-medium">Analytics</span>
            </div>
            ...
            <div class="sidebar-item p-3 rounded-lg cursor-pointer flex items-center space-x-3">
                ...
                <span class="text-slate-700 font-medium">Settings</span>
            </div>
        </nav>
    </div>
